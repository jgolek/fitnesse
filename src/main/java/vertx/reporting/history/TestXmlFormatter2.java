...
package vertx.reporting.history;
...
public class TestXmlFormatter2 extends BaseFormatter implements ExecutionLogListener, Closeable {
    private static final Logger LOG = Logger.getLogger(TestXmlFormatter2.class.getName());
    ...
    private File testHistroyDirectory;

    public TestXmlFormatter2(File testHistroyDirectory, PageFactory pageFactory, final WikiPage page, HistoryWriterFactory source) {
        super(page);
        this.pageFactory = pageFactory;
        totalTimeMeasurement = new TimeMeasurement().start();
        testResponse = new TestExecutionReport(new FitNesseVersion(), page.getPageCrawler().getFullPath().toString());
        resetTimer();
        this.testHistroyDirectory = testHistroyDirectory;
    }
    ...
    public void testExceptionOccurred(Assertion assertion, ExceptionResult exceptionResult) {
        ...
        try {
            ...
            LOG.log(Level.WARNING,
                            "Unable to process assertion " + assertion + " with exception result " + exceptionResult,
                            e);
        }
    }
    ...
    protected void writeResults() throws IOException {
        ...
        File resultPath = new File(makePageHistoryFileName(this.testHistroyDirectory, getPage(), getPageCounts(), totalTimeMeasurement.startedAt()));
        ...
        PrintWriter writer = new PrintWriter(resultFile, FileUtil.CHARENCODING);
        writeResults(writer);
    }
    ...
    protected void writeResults(Writer writer) throws IOException {
        ...
        Template template = pageFactory.getVelocityEngine().getTemplate("testResults.vm");
