...
public class FitNesseMain2 {
  private static final Logger LOG = Logger.getLogger(FitNesseMain2.class.getName());
  ...
  public static void main(String[] args) throws Exception {
    ...
    Integer exitCode = 0;
    try {
        exitCode = new FitNesseMain2().launchFitNesse(arguments);
    } catch (Exception e){
  ...
  public void configureLogging(boolean verbose) {
    ...
    InputStream in = FitNesseMain2.class.getResourceAsStream((verbose ? "verbose-" : "") + "logging.properties");
    try {
